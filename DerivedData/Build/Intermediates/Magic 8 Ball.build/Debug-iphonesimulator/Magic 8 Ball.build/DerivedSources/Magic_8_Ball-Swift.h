...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Magic_8_Ball",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12Magic_8_Ball11AppDelegate")
...
SWIFT_CLASS("_TtC12Magic_8_Ball13SceneDelegate")
...
- (IBAction)askButtonPressed:(id _Nonnull)sender;
